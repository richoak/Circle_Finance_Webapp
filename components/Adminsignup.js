    ...
    if (firstname === "") {
      ...
      var settingsthree = {
        ...
        "email" : document.getElementById("emailaddress").value,
          ...
          "assign_role" : document.getElementById("role").value,
        ...
        error: function (xhr, status, error) {
          if(xhr.status === 409){
            ...
            setnotify2("E-mail not accepted")
            $(".spinner-border").css({ 'display': 'none' });
          }
        },
      }
...
setpin1(pin1)
              ...
              <div className="registerbox1">
                ...
                <Form.Group className="mb-3" controlId="formBasicEmail">
                  ...
                  <div className="row">
                    ...
                    <div className="col-md-11 col-11">
                      <Form.Control id="emailaddress" onKeyDown={inputemail} type="text" placeholder="Enter a '@rich-oak.com' email "/>
  ...
  <select className="form-control" id="role">
    ...
    <option value="CC">Credit Comittee</option>
