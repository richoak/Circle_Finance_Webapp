...
const Premiumdrawer = (props) => {
    ...
    async function postInvestmentCard() {
      ...
      let obj = {
        "goal": goal,
        "frequency": localStorage.getItem("premiumfrequency"),
        "duration":  localStorage.getItem("premiumduration"),
        "interest_payout_method": "monthly",
        "amount": amount,
        "type": "premium",
    ...
    const gotostagetwo = () => {
      ...
      if(frequencyRef.current.value=="" || durationRef=="" || amountRef.current.value ==""){
    ...
    const selectDuration = (e) => {
      ...
      localStorage.setItem("premiumduration", e.target.value)
    }

    const selectFrequency = (e) => {
      setfrequency(e.target.value)
      localStorage.setItem("premiumfrequency", e.target.value)
      
    }

    const selectGoal = (e) => {
      setgoal(e.target.value)
      localStorage.setItem("premiumgoal", e.target.value)
    ...
    const selectAmount = (e) => {
      ...
      localStorage.setItem("premiumamount", e.target.value)
      ...
      <div className="row">
                    <div className="col-md-6">
                        <div className="row" style={{marginTop:"38px"}}>
                            ...
                            <div className="col-md-6">
                            <p className={classes.investmentrate2}>12% Annual Return.</p>
                            </div>
...
<div className="row"  style={{marginTop:"24px"}}>
    ...
    <div className="col-md-6 col-6 summarydiv1">
        ...
        <p className="summaryhead" style={{marginTop:"-16px"}}>Premium</p>
